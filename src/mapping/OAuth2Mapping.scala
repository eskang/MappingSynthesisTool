...
object OAuth2Mapping {
  ...
  def mappingReduced = {    
    ...
    new Mapping(Set(a2h, i2h, f2h, g2h))    
  }
  ...
  def mappingSpinOriginal = {
    ...
    /*
    f2h.addNotEqualConstraints(
       Map("req.url.query2" -> "session")    
     )    
     */
